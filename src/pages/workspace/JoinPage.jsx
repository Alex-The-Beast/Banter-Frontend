    ...
    <div className="h-[100vh] flex flex-col gap-y-8 items-center justify-center p-8 bg-white rounded-lg shadow-sm">
        <div className="flex flex-col items-center justify-center gap-y-4">
            ...
            classNames={{
                ...
                character:'h-auto rounded-md border border-gray-300 flex items-center justify-center focus:outline-none text-lg font-medium focus:border-blue-500 focus:ring-1 focus:ring-blue-500',
